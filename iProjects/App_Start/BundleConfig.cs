    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                    "~/Scripts/js/plugins/jquery/jquery-{version}.js"));
           ...
           bundles.Add(new ScriptBundle("~/bundles/signalr").Include("~/Scripts/jquery.signalR-{version}.js", "~/Scripts/knockout.js", "~/Scripts/jquery.cookie.js",
                    "~/Scripts/board.js"));

           bundles.Add(new ScriptBundle("~/bundles/tinymce").Include(
          "~/Scripts/tinymce/tinymce*",
          "~/Scripts/tinymce/jquery.tinymce*"));
        }
    }
}
